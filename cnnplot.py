...
# Create traces
fig = go.Figure()
fig.add_trace(go.Scatter(x=list(range(1, 101)), y=history.history['accuracy'], mode='lines', name='Training Accuracy'))
fig.add_trace(go.Scatter(x=list(range(1, 101)), y=history.history['val_accuracy'], mode='lines', name='Validation Accuracy'))
...
fig.update_layout(title='Accuracy using CNN',
                  xaxis_title='Epochs',
